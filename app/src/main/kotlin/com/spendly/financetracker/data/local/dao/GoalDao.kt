...
interface GoalDao {
    ...
    @Query("SELECT * FROM savings_goals WHERE userId = :userId ORDER BY isPrimary DESC, createdAtMillis ASC")
    fun observeByUser(userId: String): Flow<List<SavingsGoalEntity>>
